export const product_upload_payment_receipt_html_content = (payload: {
  amount: string;
  payment_date: string;
...
<body>
  <div class="main-content">
    <div class="email-container">
      ...
      <div class="content">
        <p>Hello,</p>
        <p>Thank you for subscribing to our <strong>Product Upload Subscription</strong>. Below are the details of your transaction:</p>
