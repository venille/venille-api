...
- Here are steps to take to improve your approval chances: Bullet list of specific, actionable improvements across evidence, design choices (endpoints, sample size, biomarkers, comparators), dossier structure, documentation quality, or auditability. Omit this section if none. Example: "Here are steps to take to improve your approval chances:"
`.trim();
}
