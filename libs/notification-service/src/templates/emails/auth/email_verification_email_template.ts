      ...
      <div class="wrapper">
          <div class="container">
              <div class="content">
                  ...
                  <p>Hello ${donor},</p>
                  <p>Thank you for signing up with Venille! To complete your registration, we need to verify your email address.</p>
              ...
              <div class="footer">
                  <div class="social-links">
                      <a target="_blank" href="" style="display: inline-block; margin: 0 10px; text-decoration: none;">
