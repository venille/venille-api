export const postAdSubscriptionExpirationHtmlTemplate = (payload: {
        ...
        <div class="main-content">
            <div class="email-container">
                ...
                <div class="content">
                    ...
                    <br/>
                    <p>We hope this email finds you well. We're reaching out because your product upload subscription with Animaff is set to expire <span style="font-weight: bold;">${payload.daysToExpiration} days</span> from now on <span style="font-weight: bold;">${payload.expirationDate}</span>.</p>
                    <br/>
                    <p>Once your subscription expires, you will no longer be able to post new products and all your previously uploaded products will no longer be visible to potential buyers. This could significantly impact your sales and visibility on our platform.</p>
                    <br/>
            				<p>
